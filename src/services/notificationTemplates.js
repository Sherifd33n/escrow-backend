...
const TEMPLATES = {
  ...
  [NOTIFICATION_TYPE.PAYMENT_FAILED]: {
    ...
    message:      "Your Paystack deposit attempt was not completed.",
    emailSubject: "Payment Attempt Failed",
    emailBody: (d) => emailWrap("Payment Failed", `
      <h2 style="margin-top:0;color:#001637;">Payment Failed</h2>
      <p>Hi ${d.name || "there"},</p>
      <p>Your recent payment attempt via Paystack was not successful. No funds were deducted from your wallet.</p>`),
    smsText: "Escrow: Your payment attempt was not completed.",
  },
};
